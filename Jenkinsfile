    ...
    stages {
       ...
       stage('OWASP Dependency Check') {
        ...
        stage("Docker Image Build "){
            steps{
                script{
                   withDockerRegistry(credentialsId: '6142eb30-9e73-4e3a-bb0f-fa120814eb28') {
                        ...
                        sh "docker build -t santa3gs98 ."
                        sh "docker tag petclinic sunil3gs98/santa3gs98:latest"
         ...
         stage('Trivy Scan') {
            steps {
                sh "trivy image sunil3gs98/santa3gs98:latest > trivy-report.txt"
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: '6142eb30-9e73-4e3a-bb0f-fa120814eb28') {
                        ...
                        sh "docker push sunil3gs98/santa3gs98:latest"
